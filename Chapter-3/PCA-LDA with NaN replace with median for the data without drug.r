...
plot(X[,1],X[,2],type="p",col=co, pch=pch1, xlab="PC1 26.70%", ylab="PC2 10.69%",main="PCA for data without drug with NaN replace with median")
legend("topleft", c("N","H","A"), cex = 1, pch = 1:3, col = 1:3)
biplot(pc,xlab="PC1 26.70%", ylab="PC2 10.69%",main="PCA biplot for data without drug with NaN replace with median")
plot3d(X[,1],X[,2],X[,3],type="s",col=co,xlab="PC1 26.70%", ylab="PC2 10.69%",zlab = "PC3 7.64%")
