...
plot(fScores[,c(1,2)], type = "p", xlim = c(xmi, xma), ylim = c(ymi, yma), xlab = "LD 1", pch = pch1, col = co, ylab = "LD 2", main = sprintf("(A) PC-LDA based on Autoscaling"),cex=1.5,lty=2,cex.lab = 1.5,cex.main=1.5)
