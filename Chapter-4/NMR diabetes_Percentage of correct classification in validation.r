comp = read.table("NMR diabetes comparison.csv",sep=",",header=T)

plot(comp[,2],xlim=c(1,40),ylim=c(55,95),type = "n",lwd=2, lab = c(35,10,7),ylab = "Prediction accuracy (%)", xlab = "Number of components",cex.lab = 1.4,cex.main = 1.4,cex.main=1.4,main="(A) NMR type 2 diabetes data")
