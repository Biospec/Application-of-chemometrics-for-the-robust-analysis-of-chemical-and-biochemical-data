comp = read.table("NMR AKI comparison.csv",sep=",",header=T)

plot(comp[,2],xlim=c(1,25),ylim=c(40,80),type = "n",lwd=2, lab = c(15,10,7),ylab = "Prediction accuracy (%)", xlab = "Number of components",cex.lab = 1.4,cex.main = 1.4,cex.main=1.4,main="(C) NMR Acute kidney injury data")
