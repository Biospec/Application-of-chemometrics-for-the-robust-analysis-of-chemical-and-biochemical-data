...
pc = prcomp(mydata, scale.=F,center=F)
...
plot(fScores[,c(1,2)], type = "p", xlim = c(xmi, xma), ylim = c(ymi, yma), xlab = "LD 1", pch = pch1, col = co, ylab = "LD 2", main = sprintf("(F) PC-LDA based on None scaling"),cex=1.5,lty=2,cex.lab = 1.5,cex.main=1.5)
legend("topright", c("Wild", "tt4", "mto 1"), cex = 1.5, pch = 1:3, col = 1:3, pt.cex = pointSizeLegend)
